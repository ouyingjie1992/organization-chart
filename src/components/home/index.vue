    ...
    <div class="homePage">
        ...
        <div class="content">
            ...
            <div class="resultData-box">
                ...
                <a class="sin-btn" @click="download(index)" v-for="(item, index) in resultData">下载图片{{index+1}}</a>
            </div>
...
export default {
    ...
    methods: {
        ...
        // 下载svg
        download(index) {
            let svg = this.$refs['organization-chart-body'][index].$refs.organizationChart2.children[0];
            if (svg == null) {
