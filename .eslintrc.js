...
module.exports = {
    ...
    rules: {
        ...
        'no-compare-neg-zero': 0, // 禁止与 0 进行比较  
        ...
        'no-loop-funcs': 1, // 禁止在循环中出现 function 声明和表达式  
        ...
        'wrap-iife': [1, "any"], // 要求 IIFE 使用括号括起来  
        'yoda': [2, "never", { "exceptRange": true }], // 要求或禁止 “Yoda” 条件  
